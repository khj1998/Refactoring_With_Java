...
public class StudyDashboard {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        studyDashboard.print(PrinterMode.CONSOLE);
    }

    private void print(PrinterMode mode) throws IOException, InterruptedException {
        checkGithubIssues(getGhRepository());
        StudyPrinter studyPrinter = StudyPrinter.createStudyPrinter(mode,this.totalNumberOfEvents,this.participants);
